...
final class ContentResourceByVehicleNumberVehicleLocation
{
    public function __construct(
        public readonly ?string $vehicleNumber,
        public readonly ?int $statusCode,
        public readonly ?ContentResourceVehicleLocation $contentResource,
    ) {
    }
    ...
    public static function fromArray(array $data): self
    {
        ...
        if (isset($data['ContentResource']) && is_array($data['ContentResource'])) {
            $contentResource = ContentResourceVehicleLocation::fromArray($data['ContentResource']);
        }
